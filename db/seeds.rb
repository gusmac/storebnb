...
5.times do
  StorageSpace.create(user: user1, description: "Lorem Ipsum bitches", title: "Big storage location", photo: "https://picsum.photos/500?image=60", capacity: "15 Baby Elephants", address_city: "Canggu", address_zip_code: "80351", address_country: "Indonesia")
end
